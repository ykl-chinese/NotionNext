...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '应坤龙', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '兴趣使然', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.ykl1998.com', // 网站地址
